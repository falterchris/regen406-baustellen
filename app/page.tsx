...
export default function Home() {
  ...
  return <main>
    ...
    <section className="format-selector" id="mitmachen"><div className="format-intro"><p className="eyebrow">MITBAUEN BEI REGEN406 · AB 10 UHR</p><h2>Wie möchtest du<br />mitbauen?</h2><p>Du brauchst keine Vorerfahrung – nur Lust aufs Mitmachen. Kommt in Klamotten, die dreckig werden dürfen. Ob für ein paar Stunden oder mehrere Tage: Jede helfende Hand zählt.</p></div><div className="format-actions"><a href="#baustellenwoche"><span>A</span><strong>Baustellen-Woche</strong><small>09.–18. Oktober · Schicht auswählen</small><b>→</b></a><a href="#termine"><span>B</span><strong>Baustellen-Wochenenden</strong><small>Einzelne Tage · direkt hier eintragen</small><b>→</b></a></div></section>
    <section className="construction-week" id="baustellenwoche"><div className="construction-week-copy"><p className="eyebrow">A · 09.–18. OKTOBER 2026</p><h2>REGEN406<br />Baustellen-Woche</h2><p>Wir wollen gemeinsam die Sandarbeiten im Dachboden stemmen. Wenn jeden Tag genug von euch mitmachen, können wir die Arbeiten selbst schaffen und unserem Projekt rund 20.000 € sparen.</p><p>Für Essen, Getränke und einen gemeinsamen Ausklang am Lagerfeuer ist gesorgt. Also: Freund:innen schnappen, Schicht aussuchen und mitbauen!</p><p className="cafe-note">So. 18.10. · Baustellencafé · 15–17 Uhr</p><a href="https://docs.google.com/spreadsheets/d/1Q573HIG5Tr0UWWzKa5tOkF3D5QVw3doLtx3TN9FP4B8/edit?gid=0#gid=0" target="_blank" rel="noreferrer">Zum Schichtplan <span>↗</span></a></div><div className="construction-week-art"><span>Schicht wählen.<br />Mitbauen.</span></div></section>
    <section className="weekends" id="termine"><div className="section-heading"><p className="eyebrow">B · BAUSTELLEN-WOCHENENDEN</p><h2>REGEN406<br />Baustellen-<br />Wochenenden</h2><p>An unseren Baustellen-Wochenenden bringen wir REGEN406 gemeinsam voran. Das Baustellencafé öffnet jeweils am angegebenen Tag von <strong>15–17 Uhr</strong> – für alle, die neugierig sind, die Baustelle anschauen und uns bei Getränken und Snacks kennenlernen wollen.</p></div><h3>2026</h3><div className="cards">{cardsFor(2026)}</div><h3 className="year-heading">2027</h3><div className="cards">{cardsFor(2027)}</div></section>
